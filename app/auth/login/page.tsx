  ...
  return (
    <main className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <button onClick={handleGoogle} className="w-full border border-black/15 rounded-full py-3 text-[14px] font-medium text-brand-dark flex items-center justify-center gap-2 hover:bg-brand-light transition-colors">
