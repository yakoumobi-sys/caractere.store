...
export default function BroderieQueuePage() {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      const { data, error } = await supabase
        ...
        .select('*')
        .in('status', ['attente_broderie', 'en_broderie'])
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-8">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">File Broderie</h1>
