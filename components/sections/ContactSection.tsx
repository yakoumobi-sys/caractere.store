      ...
      <div className="max-w-[980px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[72px] items-start mt-14">
          ...
          <div className="bg-brand-light rounded-[20px] p-8">
            ...
            {sent ? (
              <div className="text-center py-8"><div className="text-[40px] mb-3">✅</div><p className="text-[15px] font-medium">Demande envoyee — reponse sous 24h !</p></div>
            ) : (
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5"><label className="text-[12px] font-medium">Produit</label>
                    <select name="produit" className="border border-black/[0.12] rounded-xl px-4 py-2.5 text-[14px] bg-white focus:outline-none">
                      <option>Choisir...</option><option>T-shirt</option><option>Polo</option><option>Gilet de travail</option><option>Gilet de securite</option><option>Casquette</option><option>Totebag</option><option>Tablier</option>
                    </select>
                  </div>
                  <div className="flex flex-col gap-1.5"><label className="text-[12px] font-medium">Quantite</label>
                    <select name="quantite" className="border border-black/[0.12] rounded-xl px-4 py-2.5 text-[14px] bg-white focus:outline-none">
                      <option>Choisir...</option><option>1-9 pieces</option><option>10-49 pieces</option><option>50-99 pieces</option><option>100-299 pieces</option><option>300+ pieces</option>
                    </select>
                  </div>
                </div>
