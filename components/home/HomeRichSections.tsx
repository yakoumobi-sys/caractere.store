      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(230px, 1fr))', gap: '16px' }}>
        {SERVICES.map((s, i) => (
          <Reveal key={s.title} delay={(i % 4) * 60}>
            <div className="card-hover liquid-glass-card" style={{ borderRadius: '20px', padding: '28px 24px' }}>
  ...
  return (
    <section style={{ padding: '0 20px 80px', maxWidth: '1100px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '14px' }}>
        {GALLERY.map((g, i) => (
          <Reveal key={g.src} delay={(i % 5) * 50}>
            <div className="card-hover liquid-glass-card" style={{
...
export function MidPageCta() {
  return (
    <section className="liquid-glass-panel" style={{ padding: '64px 20px', textAlign: 'center', borderTop: `1px solid ${C.line}`, borderBottom: `1px solid ${C.line}` }}>
      <Reveal>
